...
<head>
    ...
    <title> ELECTRONIC MEDICAL RECORD WITH ARTIFICIAL INTELLIGENCE INTERGRATION </title>
    ...
    <!-- ################# Header Starts Here#######################--->
      ...
      <header id="menu-jk">
        ...
        <div id="nav-head" class="header-nav">
            <div class="container">
                <div class="row">
                    <div class="col-lg-2 col-md-3  col-sm-12" style="color:#000;font-weight:bold; font-size:42px; margin-top: 1% !important;">EMR
            ...
            <div class="carousel-inner">
                <div class="carousel-item ">
                    ...
                    <div class="carousel-caption vdg-cur d-none d-md-block">
                        <h5 class="animated bounceInDown">ELECTRONIC MEDICAL RECORD WITH ARTIFICIAL INTELLIGENCE INTERGRATION</h5>
    ...
    <p><?php  echo $row['PageDescription'];?>.</p><?php } ?>
        ...
        <br/>
            ...
            <div class="gallery_product col-lg-4 col-md-4 col-sm-4 col-xs-6 filter hdpe">
                <img src="assets/images/gallery/gallery_018.jpg" class="img-responsive">
            </div>

            <div class="gallery_product col-lg-4 col-md-4 col-sm-4 col-xs-6 filter sprinkle">
                <img src="assets/images/gallery/gallery_019.jpg" class="img-responsive">
            </div>
            ...
            <div class="gallery_product col-lg-4 col-md-4 col-sm-4 col-xs-6 filter spray">
                <img src="assets/images/gallery/gallery_017.jpg" class="img-responsive">
            </div>
...
?>
                        ...
                        Phone: (+254) 759 547 761 - (+254) 720 447 477 <br>
                        First Floor 
                        Kisumu - CBD,
                        Room B - 3
                        P. O. Box 100 - 40100
    ...
    <div class="copy">
            <div class="container">
         ELECTRONIC MEDICAL RECORD WITH ARTIFICIAL INTELLIGENCE INTERGRATION <br>
           <center>Copyright 2023 - 2024  All rights reserved.</center>
           Developer -> Zephania Ouma
